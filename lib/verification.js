...
function findBrandInText(text, brandName) {
  ...
  // Method 3: Check if all words exist in text (handles multi-line brand names)
  ...
  if (brandWords.length > 1) {
    const allWordsFound = brandWords.every(word => {
      // Only check words longer than 2 characters to avoid false positives
